...
<body>
    ...
    <div class="container">
        ...
        <p class="bus-info">
            ...
            <i class="fas fa-arrow-right"></i> <?php echo htmlspecialchars($schedule['source']); ?> →
                        ...
                        <div class="seat-group-left">
                            ...
                            foreach ($left_seats as $seat_num):
                                if ($seat_num <= $total_seats):
                                    ...
                                    ?>
                                    <div class="seat <?php echo $class; ?>" data-seat="<?php echo $seat_num; ?>"
        ...
        <div class="booking-info">
            ...
            <div class="info-item"><i class="fas fa-money-bill-wave"></i> Fare: <strong>NPR
                    <?php echo number_format($schedule['fare']); ?></strong> per seat</div>
            <div class="info-item"><i class="fas fa-users"></i> Available:
