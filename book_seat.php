...
<body>
    ...
    <h2>Book Seats for
        <?php echo $schedule['bus_name'] . " (" . $schedule['source'] . " → " . $schedule['destination'] . ")"; ?></h2>
    <p>Departure: <?php echo $schedule['departure_time']; ?> | Arrival: <?php echo $schedule['arrival_time']; ?> |
        Available Seats: <?php echo $schedule['available_seats']; ?></p>
