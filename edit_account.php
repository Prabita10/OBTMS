...
.container { background:#fff; padding:30px; border-radius:10px; box-shadow:0 2px 8px rgba(0,0,0,0.2); width:400px; position:relative; }
...
<form id="editForm" method="POST" onsubmit="return validateForm();">
    ...
    <input type="text" name="phone" id="phone" value="<?php echo htmlspecialchars($user['phone']); ?>" required placeholder="10 digits starting with 9">
